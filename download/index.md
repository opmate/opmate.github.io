...
- **OPMATE Agent _v1.1.004_** (*OPMATE Master v1.1.20200309 이상 필요*)
  - [opma-inst-1.1.004-20200409.tar.gz](opma-inst-1.1.004-20200409.tar.gz)
    - CentOS 7/6/5 - x86_64bit
    - AIX 7.2/7.1/6.1/5.3 - ppc_64bit
    - Solaris 10/9 - sparc_64bit
	- HP-UX B.11.23 - ia_64bit
  - [opma-inst-1.1.004-20200409.exe](opma-inst-1.1.004-20200409.exe_)
