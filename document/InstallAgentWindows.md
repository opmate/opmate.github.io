...
=======
실행 메뉴에서 wordpad 를 입력하여 워드패드를 실행합니다.
에이전트가 설치된 디렉토리의 설정 파일(ex. C:\infsw\opma\cfg\agent.conf)을 열고, 라인별 맨 앞의 주석(#기호) 제거하고 올바른 마스터서버의 접속 정보(ex. 111.222.333.444)로 수정합니다.
>>>>>>> branch 'master' of https://github.com/opmate/opmate.github.io.git
